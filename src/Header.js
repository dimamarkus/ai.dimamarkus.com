...
import { SwitchHorizontalIcon, ScaleIcon, CircleStackIcon, UserCircleIcon,
												...
												<div>
													...
													<div className="flex">
														<div className={`items-center flex inline-flex ${this.props.store.profile.credits ? " bg-gray-100 text-gray-500" : " bg-red-100 text-red-500"} text-sm rounded-md px-3 py-1 font-medium my-2 mr-2`}>
															<CircleStackIcon className="w-4 h-4 mr-2" />{this.props.store.profile.credits}&nbsp;<span className="hidden lg:block">credits remain</span>
														</div>
													</div>
												</div>
										</Body>
